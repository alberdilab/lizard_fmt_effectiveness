...
Modelq0GLMMNB <- glmmTMB::glmmTMB(richness ~ treatment + (1|individual), 
                      data = alpha_div_meta, 
                          family = nbinom2)
summary(Modelq0GLMMNB)
...
save(ancombc_FMT_transplant_1203, file = "data/ancombc_FMT_transplant_1203.Rdata")
```

```{r load_ancombc_fmt_tranp, warning=FALSE, comments="", message=FALSE}
load("data/ancombc_FMT_transplant_1203.Rdata")
```
