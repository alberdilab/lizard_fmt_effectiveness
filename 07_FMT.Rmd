...
alpha_div %>%
  ...
  geom_jitter(width = 0.2, show.legend = FALSE) +
  geom_boxplot(width = 0.5, alpha=0.5, outlier.shape = NA, show.legend = FALSE) +
  scale_color_manual(name="Time point",values=c("#003a45",'#008080', "#d5b52c", "#76b183",'#40714b50')) +
  scale_fill_manual(name="Time point",values=c("#003a45",'#008080', "#d5b52c", "#76b183",'#40714b50')) +
  facet_wrap(. ~ metric, scales = "free") +
  theme_classic() +
  theme(
    strip.background = element_blank(),
...
save(ancombc_FMT_Donor_2803, file = "data/ancombc_FMT_Donor_2003.Rdata")
```

```{r load_ancombc_fmt_tranp, warning=FALSE, comments="", message=FALSE, eval=FALSE}
load("data/ancombc_FMT_Donor_2003.Rdata")
```
