...
***Functional***
```{r LMM_func_accli, comment="", message=FALSE, warning=FALSE}
...
***Functional***
```{r permanova_func_accli, comment="", message=FALSE, warning=FALSE}
...
***Functional***
```{r permanova_func5, comment="", message=FALSE, warning=FALSE}
func <- as.matrix(beta_q1f$S)
func <- as.dist(func[rownames(func) %in% samples_to_keep,
               colnames(func) %in% samples_to_keep])
betadisper(func, subset_meta$treatment) %>% permutest(.) 
...
***Functional***
```{r LMM_func6, comment="", message=FALSE, warning=FALSE}
Model_funct <- lme(fixed = functional ~ treatment, data = alpha_div_meta,
               random = ~ 1 | individual)
#summary(Model_funct)
